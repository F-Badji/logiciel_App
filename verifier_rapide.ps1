...
Write-Host "VERIFICATION RAPIDE DE L'INSTALLATION" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan

Write-Host ""
Write-Host "STATUT DES OUTILS:" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "FONCTIONNALITÉS PRÊTES:" -ForegroundColor Yellow
